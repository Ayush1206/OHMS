...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-2xl font-bold text-william mb-6">Teacher Profile</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-porcelain p-4 rounded-lg shadow-sm">
          ...
          <p>Subjects Taught: Physics, Chemistry</p>
          <p>Designation: Senior Teacher</p>
        </div>
      </div>
      ...
      <div className="bg-porcelain p-4 rounded-lg shadow-sm mt-6">
        ...
        <p>Awarded 'Best Teacher of the Year' in 2019.</p>
        <p>Published 3 research papers in reputed journals.</p>
      </div>
